...
public class Mergesort {
	...
	private static void merge(int[] a, int[] tmpArray, int leftPos, 
		...
		// SÃ¥ lÃ¤nge element "finns kvar" i bÃ¤gga halvorna
		//    vÃ¤lj minsta och lÃ¤gg in tmpArray
		...
		// Kopiera ev resterande element frÃ¥n vÃ¤nster halva till tmpArray
		while (leftPos <= leftEnd) {
			tmpArray[tmpPos++] = a[leftPos++];
		}
		// Kopiera ev resterande element frÃ¥n hÃ¶ger halva till tmpArray
		while (rightPos <= rightEnd) {
			tmpArray[tmpPos++] = a[rightPos++];
		}
		// Kopiera  elementen frÃ¥n tmpArray till a
